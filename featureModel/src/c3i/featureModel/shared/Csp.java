...
import c3i.featureModel.shared.search.FindFirstTreeSearch;
import c3i.featureModel.shared.search.TreeSearch;
...
abstract public class Csp<A extends Assignments, C extends Csp> implements AutoAssignContext, SimplePicks<Var> {
