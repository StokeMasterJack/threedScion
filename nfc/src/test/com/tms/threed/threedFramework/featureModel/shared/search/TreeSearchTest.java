...
import com.tms.threed.threedFramework.featureModel.data.TrimColor;
import com.tms.threed.threedFramework.featureModel.data.TrimColorOption;
...
//        System.err.println();
    ...
    public void testExists() throws Exception {
        ...
        JpgId jpgId = new JpgId(seriesKey, JpgWidth.W_STD, fp);
        boolean exists = genRepo.exists(jpgId);
    ...
    public static class RepoJpgExistsChecker {
        ...
        public boolean exists(String fingerprint) {
            JpgId jpgId = new JpgId(seriesKey, jpgWidth, fingerprint);
            return genRepo.exists(jpgId);
        }
    }
...
//        csp.assignTrue("LF13");
    ...
    public ThreedModel getAvalon() {
        return repos.getThreedModel("avalon", 2011);
    }
    ...
    public ThreedModel getTundra() {
        return repos.getThreedModel("tundra", 2011);
    }
