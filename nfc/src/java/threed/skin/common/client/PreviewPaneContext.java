...
import threed.skin.previewPanel.shared.viewModel.*;
...
import threed.core.threedModel.client.ImageUrlProvider;
...
//                picks.setSlice(previewPanel.getSlice());
    ...
    private ImageUrlProvider imageUrlProvider = new ImageUrlProvider() {
        @Override
        public ImImageStack getImageUrl(Slice viewState) {
...
//    }
    ...
    private void refreshImagePanel(ViewPanel threedImagePanel, int panelIndex) {
        ...
        if (picksError()) {
            ...
            ImImageStack imageStack = getImageStack(slice);
            if (pngMode) {
    ...
    private void refreshImagePanelPngMode(ViewPanel threedImagePanel, ImImageStack imageStack) {
    ...
    private void refreshImagePanelJpgMode(ViewPanel threedImagePanel, ImImageStack imageStack) {
    ...
    public ImImageStack getImageStack(Slice slice) {
        assert fixResult != null;
        ImImageStack imageStack = threedModel.getImageStack(slice, fixResult.getAssignments());
        return imageStack;
    }
