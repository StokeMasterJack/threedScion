...
import threed.admin.client.featurePicker.VarPanelFactory;
...
import threed.core.featureModel.shared.picks.UiPicksChangeEvent;
import threed.core.featureModel.shared.picks.UiPicksChangeHandler;
import threed.core.imageModel.shared.*;
import threed.core.threedModel.client.SeriesNotSetException;
...
public class SeriesPanel extends ResizeComposite implements TabAware {
...
//            return layer.currentPng;
    ...
    private StatusPanelModel statusPanelModel = new StatusPanelModel() {
        ...
        @Override
        public ImImageStack getImageStack() {
            Slice currentSlice = getCurrentSlice();
