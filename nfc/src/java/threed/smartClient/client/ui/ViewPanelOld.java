...
import threed.skin.common.client.BlinkOverlay;
...
public class ViewPanelOld extends AbsolutePanel {
    ...
    public ViewPanelOld(int panelIndex, ImageSize imageSize) {
        this(panelIndex, imageSize, false);
    }

    public ViewPanelOld(int panelIndex, ImageSize imageSize, boolean dragEnabled) {
