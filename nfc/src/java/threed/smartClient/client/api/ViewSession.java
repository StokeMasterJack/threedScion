...
import threed.core.imageModel.shared.*;
...
import threed.smartClient.client.util.DoOnceScheduler;
...
public class ViewSession {
    ...
    private final ChangeTopic<ViewSession, ImageStack> imageChange1 = new ChangeTopic(this);
    private final ChangeTopic<ViewSession, ImageStack> imageChange2 = new ChangeTopic(this);
    ...
    private void recalcImageList() {
        ...
        ImImageStack imageStack = view.getImageStack(picks, currentAngle);
    ...
    private void setImageUrls(ImmutableList<Path> newValue) {
        ...
        if (!Objects.equal(oldValue, newValue)) {
            ...
            imageBatch = new ImageStack(newValue);
    ...
    public void doCacheAhead() {
        Console.log("ViewSession.doCacheAhead");
        ...
        if (cacheAheadPolicy instanceof NumAnglesBothEitherSide) {
            ...
            for (Integer angle : anglesToCache) {
                ImImageStack imageStack = view.getImageStack(picks, angle);
