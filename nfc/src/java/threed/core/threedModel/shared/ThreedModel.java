...
//    private final
    ...
    public ImImageStack getImageStack(String viewName, int angle, SimplePicks picks) {
    ...
    public ImImageStack getImageStack(Slice slice, SimplePicks picks) {
        assert slice != null;
        assert picks != null;
    ...
    public ImImageStack getImageStack(Slice slice, Assignments fixedPicks) {
        assert slice != null;
    ...
    public ImImageStack getImageStack(Slice slice, ImmutableSet<Var> picks) {
        assert slice != null;
        assert picks != null;
        ImView view = imageModel.getView(slice.getViewName());
    ...
    public ImImageStack getImageStackFromRawPicks(Slice slice, ImmutableSet<String> rawPicks) {
        assert slice != null;
    ...
    public void setRepoBaseUrl(Path repoBaseUrl) {
        System.out.println("ThreedModel.setRepoBaseUrl: " + repoBaseUrl);
