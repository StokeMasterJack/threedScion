...
public class BytInteriorAngleSelector3 extends AngleSelector {

    private static final int WIDTH_PX = 263;
    public static final int PREFERRED_HEIGHT_PX = 30;

    private final FlowPanel table = new FlowPanel();
//    private final AbsolutePanel absolutePanel = new


    private final List<PushButton> buttons;


    public BytInteriorAngleSelector3(ViewModel model) {
        super(model);
...
//    }
    ...
    private static Logger log = Logger.getLogger(BytInteriorAngleSelector3.class.getName());
}
