...
public class BytExteriorAngleSelector extends AngleSelector {

    private static final int WIDTH_PX = 263;
    public static final int PREFERRED_HEIGHT_PX = 30;


    public BytExteriorAngleSelector(DragToSpinModel model) {
        super(model);
        initWidget(createMainWidget());

        addStyleName("AngleSelector");
        addStyleName("SpinControl");
        addStyleName("Byt");
        addStyleName("Exterior");
    }
    ...
    private Widget createMainWidget() {
        ...
        flexTable.setHeight(PREFERRED_HEIGHT_PX + "px");
        flexTable.setWidth(WIDTH_PX + "px");
        //        setWidth("100%");
