...
public class PngRequest extends SeriesBasedRepoRequest {
    ...
    private final RevisionParameter shortSha;

    public PngRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        shortSha = new RevisionParameter(a[0]);


    }

    public RevisionParameter getShortSha() {
        return shortSha;
    }
}
