...
import com.tms.threed.threedFramework.threedModel.client.SeriesNotSetException;
...
public class SeriesViewPanel extends ResizeComposite implements TabAware {
    ...
    public SeriesViewPanel(UiContext ctx, final ThreedAdminServiceAsync service, ThreedModel threedModel, CommitHistory commit,String threedModelUrl ,RtConfig rtConfig) {
        assert service != null;
