...
import com.tms.threed.threedFramework.threedAdmin.jpgGen.client.JpgGenStatusPanel;
import com.tms.threed.threedFramework.threedAdmin.jpgGen.client.JpgQueueMasterPanel;
import com.tms.threed.threedFramework.threedAdmin.jpgGen.client.NewSeriesRepoDialog;
import com.tms.threed.threedFramework.threedAdmin.jpgGen.client.TabCloseListener;
import com.tms.threed.threedFramework.threedAdmin.main.client.messageLog.MessageLog;
import com.tms.threed.threedFramework.threedAdmin.main.client.messageLog.MessageLogView;
import com.tms.threed.threedFramework.threedAdmin.main.client.services.FetchSlicesCallback;
...
//        });
    ...
    private void localCheckin(final SeriesKey sk) {
        ...
        service.service2.addAllAndCommit(sk, null, null, new AsyncCallback<CommitHistory>() {
            @Override
            public void onFailure(Throwable e) {
            ...
            public void onSuccess(CommitHistory result) {
                final String s = "Checking-in: [" + sk + "] complete!";
                showMessage(s);
            }
        });
    }
...
//        pickSeriesForJpgGenMenuBar.populate(initData.getSeriesNameWithYears());
    ...
    private void showJpgGenStatusTab(final SeriesId seriesId, final JpgWidth jpgWidth) {
        ...
        service.fetchViews(seriesId, new FetchSlicesCallback() {
            @Override
            public void onSuccess(JSONArray jsViews) {
...
//        menuBar.addItem("Checkin", checkingCommand);
    ...
    private class PurgeRepoCacheCommand implements Command {
        ...
        public void execute() {
            ...
            service.service2.purgeRepoCache(new AsyncCallback<Void>() {
                @Override
                public void onFailure(Throwable e) {
                    e.printStackTrace();
