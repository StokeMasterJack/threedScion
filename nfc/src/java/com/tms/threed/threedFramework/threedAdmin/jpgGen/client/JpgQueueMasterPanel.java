...
import com.tms.threed.threedFramework.threedAdmin.main.client.MyDialogBox;
import com.tms.threed.threedFramework.threedAdmin.main.client.UiContext;
import com.tms.threed.threedFramework.threedAdmin.main.client.services.CancelJobCallBack;
import com.tms.threed.threedFramework.threedAdmin.main.client.services.FetchJpgStatusCallback;
import com.tms.threed.threedFramework.threedAdmin.main.client.services.JsonHelper;
import com.tms.threed.threedFramework.threedAdmin.main.client.services.RemoveJobCallBack;
...
public class JpgQueueMasterPanel extends DockLayoutPanel implements TabCloseListener {
    ...
    public JpgQueueMasterPanel(final ThreedAdminService1Async service, final UiContext ctx) {
        super(Style.Unit.EM);
        this.ctx = ctx;
...
//        };
        ...
        cancelRemoveCountColumn.setFieldUpdater(new FieldUpdater<MasterJobStatus, String>() {
            ...
            @Override public void update(int index, final MasterJobStatus o, String value) {
                ...
                if (o.isTerminal()) {
                    ...
                    service.removeJob(o.jobId, new RemoveJobCallBack() {
                    ...
                    service.cancelJob(o.jobId, new CancelJobCallBack() {
                        @Override public void onSuccess() {
    ...
    private FlowPanel createButtonPanel() {
        ...
        button.addClickHandler(new ClickHandler() {
            @Override public void onClick(ClickEvent event) {
                service.removeTerminal(new RemoveJobCallBack() {
                    @Override public void onSuccess() {
    ...
    private void refreshContent() {
        service.fetchJpgQueueStatus(new FetchJpgStatusCallback() {
