...
public class ThreedSessionImpl implements ThreedSession {

    private final ArrayList<Future<ViewStates>> viewStatesFutures = new ArrayList<Future<ViewStates>>();

    private final ValueChangeHandlers<ImmutableList<Path>> urlChangeHandlers;
    ...
    private ImmutableList<Path> urls = ImmutableList.of();

    private FixResult fixResult;

    public ThreedSessionImpl() {

        repoBaseUrl = new Path("/configurator-content");
        threedModelClient = new ThreedModelClient(uiLog, repoBaseUrl);
        urlChangeHandlers = new ValueChangeHandlers<ImmutableList<Path>>(this);
    ...
    public ImmutableList<Path> getUrls() {
        return urls;
    }
    ...
    public HandlerRegistration addUrlChangeHandler(ValueChangeHandler<ImmutableList<Path>> handler) {
