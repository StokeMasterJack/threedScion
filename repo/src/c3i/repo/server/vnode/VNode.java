...
//    }
    ...
    public VNode getChildNode(String name) {
        List<VNode> childNodes1 = getChildNodes();
        for (VNode childNode : childNodes1) {
    ...
    abstract public Properties readFileAsProperties();
}
