function api() {
    var O = '', vb = '" for "gwt:onLoadErrorFn"', tb = '" for "gwt:onPropertyErrorFn"', hb = '"><\/script>', Y = '#', Yb = '.cache.html', $ = '/', Rb = '17827A906359D86CA1FD766CCD1467ED', Sb = '8A8777A7F0B02322B37822500219D150', Tb = '91961F2C1F4B9B77CD1F04EF4E34E983', Ub = '963A90507EC68E3DDC18C865E0DE919A', Xb = ':', nb = '::', $b = '<script defer="defer">api.onInjectionDone(\'api\')<\/script>', gb = '<script id="', qb = '=', Z = '?', Eb = 'ActiveXObject', sb = 'Bad handler "', Fb = 'ChromeTab.ChromeFrame', Zb = 'DOMContentLoaded', Vb = 'F6998200A0D88E7EC9E61C859C0472B2', Wb = 'FB8CFC38FEB13EDE97B0589D04B33614', ib = 'SCRIPT', fb = '__gwt_marker_api', P = 'api', db = 'api.nocache.js', mb = 'api::', jb = 'base', bb = 'baseUrl', S = 'begin', R = 'bootstrap', Db = 'chromeframe', ab = 'clear.cache.gif', pb = 'content', X = 'end', Lb = 'gecko', Mb = 'gecko1_8', T = 'gwt.codesvr=', U = 'gwt.hosted=', V = 'gwt.hybrid', ub = 'gwt:onLoadErrorFn', rb = 'gwt:onPropertyErrorFn', ob = 'gwt:property', Pb = 'hosted.html?api', Kb = 'ie6', Jb = 'ie8', Ib = 'ie9', wb = 'iframe', _ = 'img', xb = "javascript:''", Ob = 'loadExternalRefs', kb = 'meta', zb = 'moduleRequested', W = 'moduleStartup', Hb = 'msie', lb = 'name', Bb = 'opera', yb = 'position:absolute;width:0;height:0;border:none', Gb = 'safari', cb = 'script', Qb = 'selectingPermutation', Q = 'startup', eb = 'undefined', Nb = 'unknown', Ab = 'user.agent', Cb = 'webkit';
    ...
    api.onScriptLoad = function () {
        if (H) {
            q = true;
            B()
        }
    };
    api.onInjectionDone = function () {
        p = true;
