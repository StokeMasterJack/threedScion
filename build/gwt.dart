...
String usage = "gwt.dart --mode=dev|compile --app=admin|gwtDemo|smartClient|all";

Map<String,App> apps = {

  "gwtDemo":new App(contextPath:"smartClient-demos-gwt",module:"c3i.gwtDemo.GwtDemo",startupPage:"GwtDemo.html"),
  "smartClient":new App(contextPath:"smartClient",module:"c3i.smartClient.SmartClientExportJavaScript"),
...
void doIt(bool devMode,App a) {
  ...
  var threedRepo = '$repos/c3i';
  var utilRepo = '$repos/ut';
  
  
  List<String> srcFolders = [
    '$threedRepo/nfc/src/java',
    '$threedRepo/admin-war/src',
    '$threedRepo/smartClient-demos-gwt-war/src',
...
//       'codeServerPort':     '9998',
  ...
  Process.start('java',processArgs).then((Process p){
    ...
    p.onExit = (exitCode) {
      print('exit code for ${a.contextPath}: $exitCode');
    };
